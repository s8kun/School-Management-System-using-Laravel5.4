        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <input name="name" type="text" class="form-control" id="inputSubjectName" placeholder="Enter subject name" value="{{ old('name', $subject->name) }}">
                </div>
                <div class="form-group">
                    <label for="inputSubjectScore">Final Degree</label>
                    <input name="score" type="number" step="0.01" min="0" class="form-control" id="inputSubjectScore" placeholder="Enter final degree" value="{{ old('score', $subject->score) }}">
                </div>
                <div class="form-group">
